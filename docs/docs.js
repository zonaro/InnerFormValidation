(function () {
    var api = window.InnerFormValidation;
    ...
    var translations = {
        en: {
            ...
            'JavaScript toolkit · documentação completa': 'JavaScript toolkit · complete documentation', 'Máscaras, regras brasileiras, conteúdo, datas, cartões, callbacks, CEP e geolocalização. Tudo funciona com JavaScript puro. Se jQuery existir, o plugin legado continua disponível.': 'Masks, Brazilian rules, content, dates, cards, callbacks, ZIP code and geolocation. Everything works with plain JavaScript. If jQuery exists, the legacy plugin remains available.',
        ...
        es: {
            ...
            'JavaScript toolkit · documentação completa': 'JavaScript toolkit · documentación completa', 'Máscaras, regras brasileiras, conteúdo, datas, cartões, callbacks, CEP e geolocalização. Tudo funciona com JavaScript puro. Se jQuery existir, o plugin legado continua disponível.': 'Máscaras, reglas brasileñas, contenido, fechas, tarjetas, callbacks, código postal y geolocalización. Todo funciona con JavaScript puro. Si existe jQuery, el plugin heredado sigue disponible.',
