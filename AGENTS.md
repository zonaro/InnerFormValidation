...
- A documentação publicada fica na raiz e deve permanecer responsiva, indexável e disponível em pt-BR, inglês e espanhol.

## Estrutura

- `InnerFormValidation.js`: biblioteca e adaptador jQuery opcional.
- Raiz: site interativo de documentação, SEO, `llms.txt`, sitemap e robots.
